          ...
          <div className="grid grid-cols-4 md:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-8">
            {serviceCards.map((card) => (
              <div
                ...
                className={`group relative overflow-hidden rounded-lg lg:rounded-2xl shadow-lg transition-all duration-500 transform hover:xl:scale-105 hover:shadow-2xl cursor-pointer aspect-[1/3.25] md:aspect-[9/16] ${
            card.isRecommended 
              ...
              {card.isRecommended && (
                <div className="absolute top-1.5 left-1.5 sm:top-4 sm:left-4 z-20">
                  <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-black font-bold px-2 sm:px-4 py-2 rounded lg:rounded-full text-xs sm:text-sm shadow-lg animate-pulse">
