    ...
    <div className="bg-[#F2F2F7] py-8 md:py-16">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="flex justify-end lg:hidden mb-4">
          {!showMobileFilters && (
            <button onClick={() => setShowMobileFilters(true)} className="w-20 mr-2 bg-[#930B31] text-white font-semibold py-2 px-4 rounded-xl shadow-lg hover:bg-red-800 transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center gap-3">
